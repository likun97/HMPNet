# -*- coding: utf-8 -*-
"""
Created on Thu Oct  7 10:58:26 2021

@author: DELL
"""
# https://github.com/haochange/imguidedfilter-opencv/blob/master/imguidedfilter.py
...
def imguidedfilter(A, G, filtSize, inversionEpsilon):
    ...
    """
    sizeA = A.shape
    if len(sizeA) == 2:                  # (320, 320) 
        sizeA = (sizeA[0], sizeA[1], 1)  # (320, 320, 1)
    sizeG = G.shape
    if len(sizeG) == 2:
